...
Route::group(['middleware' => 'auth'], function () {
    ...
    // author
    Route::post('/add/new/author', 'AuthorController@addNewAuthor');
    Route::get('/get/author/backend', 'AuthorController@viewAllAuthor');
    Route::get('/delete/author/{id}', 'AuthorController@deleteAuthor');
    Route::get('/edit/author/{id}', 'AuthorController@editAuthor');
    Route::post('/update/author/name/{id}', 'AuthorController@updateAuthor');
    Route::get('/get/author/for/new/product', 'AuthorController@getAuthorForProduct');

    // publisher
    Route::post('/add/new/publisher', 'PublisherController@addNewPublisher');
    Route::get('/get/publisher/backend', 'PublisherController@viewAllPublisher');
    Route::get('/delete/publisher/{id}', 'PublisherController@deletePublisher');
    Route::get('/edit/publisher/{id}', 'PublisherController@editPublisher');
    Route::post('/update/publisher/name/{id}', 'PublisherController@updatePublisher');
    Route::get('/get/publisher/for/new/product', 'PublisherController@getPublisherForProduct');
...
Route::get('delivery-process', 'FrontendController@delivery');
Route::get('faq', 'FrontendController@faq');
Route::get('about/us', 'FrontendController@aboutUs');
Route::get('authors', 'FrontendController@authorList');
Route::get('publishers', 'FrontendController@publisherList');
...
Route::get('/author/wise/products/{slug}', 'FrontendController@authorWiseProducts');
Route::get('/publisher/wise/products/{slug}', 'FrontendController@publisherWiseProducts');
