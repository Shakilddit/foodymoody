...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
    ...
    <div class="wrapper" id="app">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link to="/home-category-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Home Category
                                        </p>
                                ...
                                <li class="nav-item">
                                    <router-link to="/author-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Author
                                        </p>
                                ...
                                <li class="nav-item">
                                    <router-link to="/publisher-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Publisher
                                        </p>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link to="/add-home-category-product" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Add HomeCategory Product
                                        </p>
                                    </router-link>
                                </li>
                                <li class="nav-item">
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <router-link to="/pending-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Pending Orders
                                        </p>
                                ...
                                <li class="nav-item">
                                    <router-link to="/processing-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Processing Order
                                        </p>
                                ...
                                <li class="nav-item">
                                    <router-link to="/complete-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Completed Orders
                                        </p>
                                ...
                                <li class="nav-item">
                                    <router-link to="/declined-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Declined Orders
                                        </p>
                        ...
                        <!-- @if(Auth::user()->coupon == 1)
                            ...
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <router-link to="/add-coupon" href="" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                New Coupon
                                            </p>
                                    ...
                                    <li class="nav-item">
                                        <router-link to="/coupon-list" href="" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                All Coupons
                                            </p>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <router-link to="/blogCategory-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Page Categories
                                        </p>
                                ...
                                <li class="nav-item">
                                    <router-link to="/blog-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            All Page
                                        </p>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <!-- <li class="nav-item">
                                        <router-link to="/loader-list" href="" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Website Loader
                                            </p>
                                ...
                                <!-- <li class="nav-item">
                                        <router-link to="/websiteColor-list" href="" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Website Color
                                            </p>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <router-link to="/poster-list" href="" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>
                                            Posters
                                        </p>
                        ...
                        {{-- Payment  --}}
                        <li class="nav-item">
                            <router-link to="/payment-list" href="" class="nav-link">
                        ...
                        <!-- <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <router-link to="/sms-list" href="" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                SMS 
                                            </p>
                                    ...
                                    <li class="nav-item">
                                        <router-link to="/send-sms" href="" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>
                                                Send SMS
                                            </p>
        ...
        <footer class="main-footer text-right">
            <strong>Develop by <a href="https://decode-lab.com" target="_blank">Decode-Lab</a></strong>
        </footer>
