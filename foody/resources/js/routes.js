...
// backend components for Author
import EditAuthor from './components/admin/author/Edit.vue';
import AuthorList from './components/admin/author/List.vue';
import AddAuthor from './components/admin/author/New.vue';

// backend components for Publisher
import EditPublisher from './components/admin/publisher/Edit.vue';
import PublisherList from './components/admin/publisher/List.vue';
import AddPublisher from './components/admin/publisher/New.vue';
...
export const routes = [
    ...
    { path: '/edit-author/:authorId', component: EditAuthor },

      //path for Publisher
      { path: '/publisher-list', component: PublisherList },
      { path: '/add-publisher', component: AddPublisher },
      { path: '/edit-publisher/:publisherId', component: EditPublisher },
