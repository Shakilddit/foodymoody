                        ...
                        <div class="card card-primary mt-3">
                            ...
                            <form role="form">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="authorID">New Author Name</label>
                                        <input type="text" class="form-control" id="authorID" placeholder="Enter Author Name" v-model="form.author_name" name="author_name" :class="{ 'is-invalid': form.errors.has('author_name') }">
                                        <has-error :form="form" field="author_name"></has-error>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <button type="submit" class="btn btn-primary" @click.prevent="addAuthor()">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
