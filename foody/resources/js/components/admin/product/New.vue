                                           ...
                                           <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="authorID" v-model="form.author_id"  :class="{ 'is-invalid': form.errors.has('author_id') }">
                                                            <option disabled value="">Select One</option>
                                                            <option v-for="author in getAuthorForProduct" :value="author.id" :key="author.id">{{author.name}}</option>
                                                        </select>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="publisherID" v-model="form.publisher_id"  :class="{ 'is-invalid': form.errors.has('publisher_id') }">
                                                            <option disabled value="">Select One</option>
                                                            <option v-for="publisher in getPublisherForProduct" :value="publisher.id" :key="publisher.id">{{publisher.name}}</option>
                                                        </select>
                                                        <has-error :form="form" field="publisher_id"></has-error>
                                                    </div>
                                                </div>
                                            </div>
...
export default {
    ...
    computed:{
        ...
        getAuthorForProduct(){
            return this.$store.getters.getAuthorForProduct
        },
        getPublisherForProduct(){
            return this.$store.getters.getPublisherForProduct
        }
    },
    methods:{
        ...
        async loadInitialData() {
            try {
                await this.$store.dispatch("allCategoryForNewProduct");
                await this.$store.dispatch("allAuthorForNewProduct");
                await this.$store.dispatch("allPublisherForNewProduct");
            } catch (error) {
