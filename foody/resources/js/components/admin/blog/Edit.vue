                    ...
                    <div class="col-md-10">
                        <div class="card card-primary mt-3">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-boxes"></i> Edit Page</h3>
                            </div>
                            <form role="form" enctype="multipart/form-data" @submit.prevent="updateBlog()">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="form-group">
                                                <label for="categoryID">Select Page Category</label>
                                            ...
                                            <div class="form-group">
                                                <label for="tagsID">Seo Tags (optional)</label>
                                    ...
                                    <div class="form-group">
                                        <label for="DescriptionID">Page Description</label>
