...
export default {
    ...
    getters: {
        ...
        getAuthorForProduct(state) {
            return state.authorForProduct
        },
        getPublisherForProduct(state) {
            return state.publisherForProduct
        },
    ...
    actions: {
        ...
        allAuthor(context, url) {
            axios.get(url)
                .then((response) => {
                    context.commit('authors', response.data.authors.data)
                })
        },
        allPublisher(context, url) {
            axios.get(url)
                .then((response) => {
                    context.commit('publishers', response.data.publishers.data)
                })
        },
        allSms(context, url) {
            axios.get(url)
        ...
        allAuthorForNewProduct(context) {
            axios.get('/get/author/for/new/product')
                .then((response) => {
                    context.commit('allproductsForAuthor', response.data.authors)
                })
        },
        allPublisherForNewProduct(context) {
            axios.get('/get/publisher/for/new/product')
                .then((response) => {
                    context.commit('allproductsForPublisher', response.data.publishers)
                })
        },
    ...
    mutations: {
        ...
        allproductsForAuthor(state, data) {
            return state.authorForProduct = data
        },
        allproductsForPublisher(state, data) {
            return state.publisherForProduct = data
        },
