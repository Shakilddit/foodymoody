...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        return view('public/index', compact('popup_banner', 'wish_list', 'wish_list_number', 'icon', 'banners', 'categories', 'top_posters', 'sale_products', 'deals_month_products', 'feature_products', 'trending_products', 'new_products', 'top_sale_products', 'blogs', 'cart', 'cart_number', 'about', 'footer', 'home_categories'));
    }
    ...
    public function authorList()
    {
        ...
        $wish_list_number = WishList::where('random_number', session('random_number'))->count();
        return view('public.author', compact('authors', 'wish_list', 'wish_list_number', 'icon', 'categories', 'cart', 'cart_number', 'about', 'footer'));
    }
    ...
    public function publisherList()
    {
        ...
        $wish_list_number = WishList::where('random_number', session('random_number'))->count();
        return view('public.publisher', compact('publishers', 'wish_list', 'wish_list_number', 'icon', 'categories', 'cart', 'cart_number', 'about', 'footer'));
    }
    ...
    public function authorWiseProducts($slug)
    {
        $author = Author::where('slug', $slug)->first();
        $icon = Icon::orderBy('id', 'desc')->first();
        $categories = Category::all();
        $most_viewed_products = Product::orderBy('views', 'desc')->where('status', 1)->limit(3)->get();
        $products = Product::orderBy('id', 'desc')->where('author_id', $author->id)->where('status', 1)->paginate(16);
        $about = About::orderBy('id', 'desc')->first();
        $cart = DB::table('carts')
            ->join('products', 'carts.product_id', '=', 'products.id')
            ->select('carts.*', 'products.name as product_name', 'products.image as product_image', 'products.slug as product_slug')
    ...
    public function publisherWiseProducts($slug)
    {
        $publisher = Publisher::where('slug', $slug)->first();
        $icon = Icon::orderBy('id', 'desc')->first();
        $categories = Category::all();
        $most_viewed_products = Product::orderBy('views', 'desc')->where('status', 1)->limit(3)->get();
        $products = Product::orderBy('id', 'desc')->where('publisher_id', $publisher->id)->where('status', 1)->paginate(16);
        $about = About::orderBy('id', 'desc')->first();
        $cart = DB::table('carts')
            ->join('products', 'carts.product_id', '=', 'products.id')
            ->select('carts.*', 'products.name as product_name', 'products.image as product_image', 'products.slug as product_slug')
    ...
    public function faq()
    {
        ...
        $about = Blog::where('category_id', 2)->orderBy('id', 'desc')->first();
        ...
        $wish_list_number = WishList::where('random_number', session('random_number'))->count();
        return view('public.faq', compact('wish_list', 'wish_list_number', 'icon', 'categories', 'cart', 'cart_number', 'about', 'footer'));
    }
    ...
    public function delivery()
    {
        ...
        $cart_number = Cart::where('random_number', session('random_number'))->count();
        $about = Blog::where('category_id', 1)->orderBy('id', 'desc')->first();
        $footer = Footer::orderBy('id', 'desc')->first();
        ...
        $wish_list_number = WishList::where('random_number', session('random_number'))->count();
        return view('public.delivery', compact('wish_list', 'wish_list_number', 'icon', 'categories', 'cart', 'cart_number', 'about', 'footer'));
    }
